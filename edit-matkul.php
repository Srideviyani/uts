...
<body style="background: #152733;">
    ...
    $qry = "SELECT * FROM matkul WHERE id_matkul = '$id_matkul'";
        ...
        <div class="row align-items-center vh-100">
            <div>
                ...
                <div class="text-white pb-4">
                    <h1 class="h4 fw-bold">Form Edit Matkul</h1>
                </div>
                <form action="update-matkul.php" method="POST" class="text-white">
                    <div class="row">
                        <div class="col-md-6">
                            <input type="text" name="id_matkul" value="<?= $data['id_matkul'] ?>" hidden>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="jumlah_sks" class="form-control" value="<?= $data['jumlah_sks'] ?>">
                        </div>
                    </div>
                    <div>
